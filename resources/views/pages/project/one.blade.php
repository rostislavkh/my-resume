...
@section('title', __('Name project by Rostislav Khorolskiy'))
...
@section('content')
    <div class="container-2">
        ...
        <div class="about-project">
            <div class="about-project__title">About</div>
            <div class="about-project__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta delectus officia tempore officiis? Labore quasi fugiat reprehenderit amet architecto. Minus alias maiores nam vitae dolore, facere debitis ea? Accusamus, inventore!</div>
        </div>
    </div>
@endsection