                ...
                Layout::tabs([
                    'Projects info' => [
                        Layout::rows([
                            ...
                            SimpleMDE::make('description')->title('Description')->required(),
                            SimpleMDE::make('description_uk')->title('Description [Ukraine lang]'),
                            Group::make([
                ...
                Layout::accordion([
                    'Projects info' => [
                        Layout::rows([
                            ...
                            SimpleMDE::make('model.description')->title('Description'),
                            SimpleMDE::make('model.description_uk')->title('Description [Ukraine lang]'),
                            Group::make([
